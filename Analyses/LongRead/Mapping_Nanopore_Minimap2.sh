...
for i in "${samples[@]}"; do
  ...
  echo ""
	...
	/home/volker/Tools/minimap2/minimap2 -t 15 -ax splice -k14 -uf --junc-bed /home/volker/reference/Gencode/gencode.v42.SIRVomeERCCome.annotation_forMinimap2.bed /home/volker/reference/Gencode/GRCh38.primary.SIRVomeERCCome.fa ${outdir}/FASTQ/${i}.fastq.gz > ${outdir}/BAM/${i}.sam
